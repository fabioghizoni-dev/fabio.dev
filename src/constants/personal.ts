  ...
  professionalHistory: [
    {
      ...
      summary: "CONSERTOS ELÉTRICOS EM GERAL, FECHADURAS, MOTORES ELÉTRICOS, TROCA DE VIDROS E ACABAMENTOS."
    },
    {
      date: "Outubro de 2022 - Novembro de 2022",
      name: "PREFEITURA MUNICIPAL DE MANOEL RIBAS – ARRASTÃO DA DENGUE.",
      summary: removeSpaces(`VISITAS NAS CASAS DOS MORADORES DOS BAIRROS DA CIDADE, COM O OBJETIVO DE ORIENTAR E FAZER A LIMPEZA 
    ...
    },
    {
      ...
      summary: "AUXILIAR DE MECÂNICO, TROCA DE ÓLEO, CÂMBIO, MOTORES DIESEL EM GERAL."
    },
    {
      date: "Outubro de 2024 - Fevereiro de 2025",
      name: "ANDERSON DA SILVA - SOFTWARE E CONSULTORIA.",
      summary: "DESENVOLVEDOR TRAINEE, DESAFIOS TÉCNICOS, CURSOS SOBRE DELPHI E RAD STUDIO, CONHECIMENTO SOBRE REGRAS DE NEGÓCIO."
    },
    {
      date: "Maio de 2025 - Dezembro de 2025",
      name: "CONSÓRCIO INTERMUNICIPAL DE SAÚDE DE IVAIPORÃ.",
      summary: "CHEFE DO SETOR DE RECURSOS HUMANOS, GERENCIEI A FOLHA DE 25 FUNCIONÁRIOS E ESTAGIÁRIOS."
    },
  ]
}